...
import { ImageMockUp } from "@/app/assets/images";
          ...
          <div className="-mx-4 flex flex-wrap items-center">
            <div className="w-full px-4 lg:w-7/12">
              ...
              >
                <span className="mb-5 block text-lg font-medium leading-tight text-black dark:text-white sm:text-[22px] xl:text-[22px]">
                  Seamless Ride Booking with Gadiyo App.
                </span>
                <h1 className="mb-6 text-3xl font-bold leading-tight text-black dark:text-white sm:text-[40px] md:text-[50px] lg:text-[42px] xl:text-[50px]">
                  ...
                  <span className="inline text-primary bg-clip-text text-transparent">
                    Car Rentals & Rides{" "}
                  </span>
                  Made Easy.
                </h1>
                <p className="mb-10 max-w-[475px] text-base leading-relaxed text-body">
                  Gadiyo connects multiple travel agencies and users on one
                  platform. Agencies list their cars, and users can quickly
                  browse, compare, and book the perfect ride with just a few
                  taps.
                </p>
            ...
            <div className="w-full px-4 lg:w-5/12">
              ...
              >
                ...
                />
                <div className="max-auto absolute top-0 left-0 right-0 -z-10 aspect-square w-full">
