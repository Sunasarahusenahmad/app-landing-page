import { About1, About2 } from "@/app/assets/images";
              ...
              <div className="w-full px-4 lg:w-1/2">
                ...
                >
                  ...
                  <h2 className="mb-4 text-3xl font-bold text-black dark:text-white sm:text-4xl md:text-[44px] md:leading-tight">
                    Browse Cars with Smart Filters
                  </h2>
                  <p className="mb-[30px] text-base leading-relaxed text-body">
                    Explore thousands of vehicles with our intelligent car
                    listing system. Filter by brand, price range, fuel type, and
                    location to find exactly what you're looking for in seconds.
                  </p>
                  ...
                  <div className="mb-[30px] flex items-center">
                    ...
                    <div>
                      ...
                      <p className="text-base text-body">
                        Find cars by make, model, year, price range, and more
                        with our smart filtering system.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p className="text-base text-body">
                        See live inventory updates and book instantly with
                        verified dealers across your city.
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div className="-mx-4 flex flex-wrap items-center justify-between">
              <div className="w-full px-4 lg:w-1/2">
                ...
                >
                  ...
                  <p className="mb-[30px] text-base leading-relaxed text-body">
                    Get comprehensive car details including high-resolution
                    photos, specifications, pricing, dealer information, and
                    genuine customer reviews all in one place.
                  </p>
        ...
        <div className="absolute right-0 top-36 -z-10">
          ...
          >
            ...
            <defs>
              ...
              >
                <stop stopColor="#D3B699" />
                <stop offset="1" stopColor="#EDD8BA" />
              </linearGradient>
            </defs>
          </svg>
        </div>
