            ...
            <div className="mt-[30px]">
              <h3>
                <Link
                  ...
                  className="mb-3 inline-block text-xl font-semibold text-black hover:text-primary dark:text-white dark:hover:text-primary sm:text-2xl"
                >
                  {blog.title}
                </Link>
              </h3>
              <p className="text-base text-body">{blog.shortContent}</p>
            </div>
          </div>
        </div>
      ))}
