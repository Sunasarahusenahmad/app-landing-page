...
export default function BlogDetail({ params }: BlogProps) {
  ...
  return (
    <section className="pt-[150px] pb-[60px] lg:pt-[220px]">
        ...
        <div className="mx-auto w-full max-w-[970px]">
          ...
          <div className="mx-auto w-full max-w-[770px] text-center">
            ...
            <div className="text-left">
              ...
              <div
                className="wow fadeInUp mb-9 text-base text-body"
                data-wow-delay=".2s"
                dangerouslySetInnerHTML={{ __html: blog.content }}
              />

              {/* Static blockquote - you can make this dynamic too if needed */}
              <blockquote
                className="wow fadeInUp relative z-10 mb-9 overflow-hidden rounded bg-[#F8FAFB] py-11 px-8 text-center text-base text-black dark:bg-[#15182A] dark:text-white md:px-12"
                data-wow-delay=".2s"
              >
                    ...
                    <div className="flex flex-wrap items-center">
                      {blog.tags.map((tag) => (
                        <a
                          ...
                          className="mr-3 mb-3 inline-flex h-9 items-center justify-center rounded bg-[#F8FAFB] px-[18px] text-sm font-semibold text-body hover:bg-primary hover:text-white dark:bg-[#15182A] dark:text-white dark:hover:bg-primary"
                        >
                          {tag}
                        </a>
                      ))}
